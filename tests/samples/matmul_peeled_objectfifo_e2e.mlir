...
// CHECK-DAG:     aiex.npu.dma_memcpy_nd(0, 0, %[[ARG0]][0, 0, 0, 0][1, 1, 64, 32][0, 0, 256, 1]) {id = 1 : i64, issue_token = true, metadata = @[[OBJ0:.+]]}
// CHECK-DAG:     aiex.npu.dma_wait {symbol = @[[OBJ0]]}
// CHECK-DAG:     aiex.npu.dma_memcpy_nd(0, 0, %[[ARG1]][0, 0, 0, 0][1, 2, 32, 32][0, 32, 128, 1]) {id = 1 : i64, issue_token = true, metadata = @[[OBJ1:.+]]}
