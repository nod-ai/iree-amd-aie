...
# ${IREE_BUILD_DIR}/tools/iree-opt matmul_peeled_2x2_small.mlir --debug-only=iree-amdaie-distribute-cores-and-objectfifos --pass-pipeline="builtin.module(fold-memref-alias-ops,iree-amdaie-pack-to-dma,air-copy-to-dma,iree-amdaie-air-dma-to-amdaie-dma,iree-amdaie-insert-cores,iree-amdaie-localize-logicalobjectfifo,cse,iree-amdaie-distribute-cores-and-objectfifos,cse)"
...
${IREE_BUILD_DIR}/tools/iree-compile --mlir-elide-elementsattrs-if-larger=2 \
    ...
    --iree-amd-aie-peano-install-dir=${WORK}/versal/llvm-aie/install \
