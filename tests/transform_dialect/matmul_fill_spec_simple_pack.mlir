...
func.func @matmul_i32() {
  ...
  %arg0_binding = hal.interface.binding.subspan layout(#pipeline_layout) set(0) binding(0) offset(%c0) flags(ReadOnly) : !flow.dispatch.tensor<readonly:tensor<2048x512xi32>>
  ...
  %arg1_binding = hal.interface.binding.subspan layout(#pipeline_layout) set(0) binding(1) offset(%c0) flags(ReadOnly) : !flow.dispatch.tensor<readonly:tensor<512x2048xi32>>
  ...
  %arg2_binding = hal.interface.binding.subspan layout(#pipeline_layout) set(0) binding(2) offset(%c0) flags(None) : !flow.dispatch.tensor<writeonly:tensor<2048x2048xi32>>
