...
if("amd-aie-xrt" IN_LIST IREE_EXTERNAL_HAL_DRIVERS)
...
if("amd-aie-hsa" IN_LIST IREE_EXTERNAL_HAL_DRIVERS)
...
if(IREE_AMD_AIE_ENABLE_HSA_DRIVER)
  set(ROCR_RUNTIME_ROOT "${CMAKE_CURRENT_LIST_DIR}/third_party/ROCR-Runtime")
endif()
