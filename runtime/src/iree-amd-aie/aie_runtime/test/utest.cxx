...
int main(int argc, char** argv) {
  ...
  AMDAIENPUDeviceModel deviceModel(
      XAIE_DEV_GEN_AIEML, XAIE2_BASE_ADDR, XAIE2_COL_SHIFT, XAIE2_ROW_SHIFT,
      NPU_NUM_COLS, NPU_NUM_ROWS, XAIE_MEM_TILE_ROW_START,
      XAIE_NUM_MEM_TILE_ROWS, XAIE_NUM_SHIM_TILE_ROWS, partitionNumCols,
      partitionStartCol);
