...
!fdt_lhs = !iree_tensor_ext.dispatch.tensor<readonly:tensor<512x4096xbf16>>
!t_rhs = tensor<4096x512xbf16>
!fdt_rhs = !iree_tensor_ext.dispatch.tensor<readonly:tensor<4096x512xbf16>>
...
hal.executable.source public @amdaie_fb {
  ...
  builtin.module {
    func.func @mm_512_512_4096_bf16_f32() {
      ...
      %3 = iree_tensor_ext.dispatch.tensor.load %0, offsets = [0, 0], sizes = [512, 4096], strides = [1, 1] : !fdt_lhs -> !t_lhs
      %4 = iree_tensor_ext.dispatch.tensor.load %1, offsets = [0, 0], sizes = [4096, 512], strides = [1, 1] : !fdt_rhs -> !t_rhs
      ...
      iree_tensor_ext.dispatch.tensor.store %7, %2, offsets = [0, 0], sizes = [512, 512], strides = [1, 1] : !t_res -> !fdt_res
      return
    }
  }
}
