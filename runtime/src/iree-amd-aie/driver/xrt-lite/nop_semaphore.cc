...
static iree_hal_xrt_lite_semaphore* iree_hal_xrt_lite_semaphore_cast(
    iree_hal_semaphore_t* base_value) {
  IREE_HAL_ASSERT_TYPE(base_value, &iree_hal_xrt_lite_semaphore_vtable);
  return reinterpret_cast<iree_hal_xrt_lite_semaphore*>(base_value);
}
...
static void iree_hal_xrt_lite_semaphore_destroy(
  ...
  iree_hal_xrt_lite_semaphore* semaphore =
      iree_hal_xrt_lite_semaphore_cast(iree_hal_semaphore_cast(base_semaphore));
...
static uint64_t iree_hal_xrt_lite_semaphore_query(
    iree_async_semaphore_t* base_semaphore) {
...
static iree_status_t iree_hal_xrt_lite_semaphore_import_timepoint(
    iree_hal_semaphore_t* base_semaphore, uint64_t value,
...
static iree_status_t iree_hal_xrt_lite_semaphore_export_timepoint(
    iree_hal_semaphore_t* base_semaphore, uint64_t value,
    iree_hal_queue_affinity_t queue_affinity,
...
const iree_hal_semaphore_vtable_t iree_hal_xrt_lite_semaphore_vtable = {
    ...
    .import_timepoint = iree_hal_xrt_lite_semaphore_import_timepoint,
    .export_timepoint = iree_hal_xrt_lite_semaphore_export_timepoint,
};
}  // namespace
