...
#include "iree-amd-aie/driver/xrt-lite/native_executable.h"
...
struct iree_hal_xrt_lite_native_executable_t {
  ...
  iree_hal_xrt_lite_kernel_info_t entry_points[];
};
...
static iree_status_t iree_hal_xrt_lite_native_executable_flatbuffer_verify(
...
//       z0, iree_hal_xrt_lite_native_executable_flatbuffer_verify(
...
//   IREE_TRACE({
//     for (iree_host_size_t entry_ordinal = 0; entry_ordinal <
//     entry_point_count;
//          entry_ordinal++) {
...
//
//     iree_hal_xrt_lite_allocator_t* allocator =
//         iree_hal_xrt_lite_allocator_cast(device_allocator);
//     iree_hal_xrt_lite_kernel_info_t* params =
//         &executable->entry_points[entry_ordinal];
//     params->num_instr = num_instr;
//     // Load the IPU and PDI files into a global pool that doesn't support
//     kernel
//     // args (DEV BO).
//     IREE_XRT_LITE_RETURN_AND_END_ZONE_IF_ERROR(
//         z0, symbols,
//         xrt_lite_amd_memory_pool_allocate(
//             allocator->global_dev_mem_pool, num_instr * sizeof(uint32_t), 0,
//             reinterpret_cast<void**>(&params->ipu_inst_buf)),
//         "xrt_lite_amd_memory_pool_allocate");
//     std::memcpy(params->ipu_inst_buf, asm_inst, num_instr *
//     sizeof(uint32_t)); IREE_XRT_LITE_RETURN_AND_END_ZONE_IF_ERROR(
//         z0, symbols,
//         xrt_lite_amd_get_handle_from_vaddr(params->ipu_inst_buf,
//                                            &params->ipu_inst_handle),
//         "xrt_lite_amd_agent_iterate_memory_pools");
...
//     IREE_XRT_LITE_RETURN_AND_END_ZONE_IF_ERROR(
//         z0, symbols,
//         xrt_lite_amd_get_handle_from_vaddr(params->pdi_buf,
//                                            &params->pdi_handle),
//         "xrt_lite_amd_agent_iterate_memory_pools");
...
//       flatbuffers_string_len(entry_name); memcpy(string_table_buffer,
//       entry_name, entry_name_length); string_table_buffer +=
//       entry_name_length;
//     });
//
//     IREE_TRACE({
//       if
//       (iree_amd_aie_hal_xrt_lite_ExecutableDef_source_locations_is_present(
//               executable_def)) {
...
iree_status_t iree_hal_xrt_lite_native_executable_entry_point_kernel_info(
    iree_hal_executable_t* base_executable, int32_t entry_point,
    iree_hal_xrt_lite_kernel_info_t* out_info) {
  iree_hal_xrt_lite_native_executable_t* executable =
      iree_hal_xrt_lite_native_executable_cast(base_executable);
