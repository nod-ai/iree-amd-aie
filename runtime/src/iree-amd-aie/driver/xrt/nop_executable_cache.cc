...
static iree_status_t iree_hal_xrt_nop_executable_cache_infer_format(
    iree_hal_executable_cache_t* base_executable_cache,
    iree_hal_executable_caching_mode_t caching_mode,
  ...
  IREE_TRACE_ZONE_BEGIN(z0);
  iree_status_t status = iree_hal_xrt_native_executable_infer_format(
...
const iree_hal_executable_cache_vtable_t
    iree_hal_xrt_nop_executable_cache_vtable = {
        ...
        /*.infer_format=*/iree_hal_xrt_nop_executable_cache_infer_format,
        /*.can_prepare_format=*/
