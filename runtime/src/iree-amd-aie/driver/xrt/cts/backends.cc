...
// CTS backend registration for the XRT HAL driver.
...
static bool xrt_registered_ =
    (CtsRegistry::RegisterBackend({
         "xrt",
         {
             ...
             {
                 {"CommandBufferTest.*",
                  "XRT command buffer tests not yet enabled in CTS"},
                 ...
                 {"CommandBufferUpdateBufferTest.*",
                  "XRT command buffer tests not yet enabled in CTS"},
                 {"CoreTest.*", "XRT core tests not yet enabled in CTS"},
                 {"EventTest.*", "XRT event tests not yet enabled in CTS"},
                 {"FileTest.*", "XRT file tests not yet enabled in CTS"},
                 {"QueueTest.*", "XRT queue tests not yet enabled in CTS"},
                 {"DispatchTest.*",
                  "XRT dispatch tests not yet enabled in CTS"},
                 ...
                 {"DispatchConstantsBindingsTest.*",
                  "XRT dispatch tests not yet enabled in CTS"},
                 {"ExecutableTest.*",
                  "XRT executable tests not yet enabled in CTS"},
             },
         },
         /*tags=*/{},
     }),
