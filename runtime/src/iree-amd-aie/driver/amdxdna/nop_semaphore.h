...
#ifndef IREE_AMD_AIE_DRIVER_AMDXDNA_NOP_SEMAPHORE_H_
#define IREE_AMD_AIE_DRIVER_AMDXDNA_NOP_SEMAPHORE_H_
...
#endif  // IREE_AMD_AIE_DRIVER_AMDXDNA_NOP_SEMAPHORE_H_
