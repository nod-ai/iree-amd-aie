...
#ifndef IREE_AMD_AIE_DRIVER_AMDXDNA_NATIVE_EXECUTABLE_H_
#define IREE_AMD_AIE_DRIVER_AMDXDNA_NATIVE_EXECUTABLE_H_
...
struct iree_hal_amdxdna_executable {
  ...
  iree_hal_amdxdna_kernel_params entry_points[16];
...
#endif  // IREE_AMD_AIE_DRIVER_AMDXDNA_NATIVE_EXECUTABLE_H_
