// RUN: iree-opt --pass-pipeline="builtin.module(iree-preprocessing-apply-pdl-patterns{patterns-file=%p/large-matmul.pdl.mlir}, cse)" %s | FileCheck %s
...
// CHECK: call @mlp_external({{.+}}) : (memref<bf16>, index, memref<bf16>, index, memref<f32>, index, i32, i32, i32) -> ()
  ...
  func.func @mlp_invocation(%lhs: tensor<8192x2432xbf16>,
                            %rhs: tensor<2432x9728xbf16>) -> (tensor<8192x9728xf32>) {
    ...
    %65 = linalg.matmul ins(%lhs, %rhs :  tensor<8192x2432xbf16>, tensor<2432x9728xbf16>) outs(%64 : tensor<8192x9728xf32>) -> tensor<8192x9728xf32>
...
// CHECK: flow.dispatch @mlp_external_bf16_bf16_f32_i32_i32_i32_executable::@mlp_external_entry_point({{.+}}) : (tensor<8192x2432xbf16>, tensor<2432x9728xbf16>, i32, i32, i32) -> tensor<8192x9728xf32>
