...
module attributes {transform.with_named_sequence} {
  ...
  stream.executable private @executable {
    ...
    builtin.module {
      ...
      func.func @mlp(%arg0: !stream.binding, %arg1: !stream.binding, %arg2: !stream.binding, %arg3: i32, %arg4: i32, %arg5 : i32) {
        ...
        %result = stream.binding.subspan %arg2[%c0] : !stream.binding -> memref<8192x9728xf32, strided<[9728, 1], offset: ?>>
        ...
        %p2, %o2, %s20, %s21, %t20, %t21 = iree_codegen.extract_strided_metadata %result : memref<8192x9728xf32, strided<[9728, 1], offset: ?>> -> memref<f32>, index, index, index, index, index
  ...
  util.func private @call_mlp(%lhs : tensor<8192x2432xf32>, %rhs :  tensor<2432x9728xf32>, %init1 : tensor<8192x9728xf32>) -> tensor<8192x9728xf32> {
    %c0 = arith.constant 0 : index
    %c1 = arith.constant 1 : index
    ...
    %mlp_result = flow.dispatch @executable::@mlp(%lhs, %rhs, %m_i32, %n_i32, %k_i32)
        : (tensor<8192x2432xf32>, tensor<2432x9728xf32>, i32, i32, i32) ->  tensor<8192x9728xf32>
  ...
  transform.named_sequence @match_mlp(%root: !transform.any_op {transform.readonly}) -> (!transform.any_value, !transform.any_value) {
    %ins, %outs = transform.iree.match.cast_compatible_dag_from_root %root {
      ^bb0(%lhs: tensor<8192x2432xf32>, %rhs: tensor<2432x9728xf32>, %init1 : tensor<8192x9728xf32>):
