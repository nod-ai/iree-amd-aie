...
// CHECK: call @mlp_external({{.+}}) : (memref<bf16>, index, memref<bf16>, index, memref<f32>, index, i32, i32, i32) -> ()
  ...
  func.func @mlp_invocation(%lhs: tensor<1x4096x4096xbf16>,
                            %rhs: tensor<1x4096x512xbf16>) -> (tensor<1x4096x512xf32>) {
    ...
    %67 = linalg.batch_matmul ins(%lhs, %rhs : tensor<1x4096x4096xbf16>, tensor<1x4096x512xbf16>) outs(%68 : tensor<1x4096x512xf32>) -> tensor<1x4096x512xf32>
