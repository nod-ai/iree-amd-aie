...
/// into smaller transfer_reads based on peano's preferred store size. For
/// example, assuming 128 bytes is the preferred store size:
///
/// INPUT:
...
/// `populateVectorUnrollPatterns` but that isn't fit for purpose:
