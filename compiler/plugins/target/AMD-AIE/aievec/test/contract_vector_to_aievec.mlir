...
module attributes {hal.executable.target = #executable_target_} {
  // Test 1: Integer matrix multiplication (4x8 x 8x8 -> 4x8)
  func.func @test_int_contract(%arg0: vector<4x8xi8>, %arg1: vector<8x8xi8>, %arg2: vector<4x8xi32>) -> vector<4x8xi32> {
    // CHECK-LABEL: @test_int_contract
