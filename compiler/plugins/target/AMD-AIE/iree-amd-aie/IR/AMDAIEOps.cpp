...
// void NpuDmaCpyNdOp::build(
//     OpBuilder &b, OperationState &result, Type resultType, Value dma,
//     Value target, ArrayRef<OpFoldResult> targetOffsets,
//     ArrayRef<OpFoldResult> targetSizes, ArrayRef<OpFoldResult> targetStrides,
//     Value targetBdId, Value source, ArrayRef<OpFoldResult> sourceOffsets,
//     ArrayRef<OpFoldResult> sourceSizes, ArrayRef<OpFoldResult> sourceStrides,
//     Value sourceBdId) {
//   build(b, result, {resultType}, dma, target, targetOffsets, targetSizes,
//         targetStrides, targetBdId, source, sourceOffsets, sourceSizes,
//         sourceStrides, sourceBdId);
// }
