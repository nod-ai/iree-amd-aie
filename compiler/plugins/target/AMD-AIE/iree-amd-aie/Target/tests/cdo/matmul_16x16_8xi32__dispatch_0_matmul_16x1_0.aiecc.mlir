...
// CHECK: trying XAIE API: XAie_LoadElf with args: &devInst={{.+}}, XAie_TileLoc(col=XAie_LocType(col: 0, row: 2), row)={{.+}}matmul_16x16_8xi32__dispatch_0_matmul_16x16x8_i32_0_core_0_2.elf, elfPath.str().c_str(), aieSim=0
...
// CHECK: trying XAIE API: XAie_DmaSetAddrLen with args: &dmaTileBd={{.+}}, basePlusOffsetInBytes=1536, lenInBytes=512
...
// CHECK: trying XAIE API: XAie_DmaSetMultiDimAddr with args: &dmaTileBd={{.+}}, &dmaTileBdTensor={{.+}}, basePlusOffsetInBytes=2048, lenInBytes=1024
