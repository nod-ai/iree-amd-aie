...
aie.device(npu1_4col) {
  ...
  %buf5 = aie.buffer(%tile_0_1) {stack_relative_address = 0 : i32, mem_bank = 0 : i32, sym_name = "buf5"} : memref<64x64xbf16>
  %buf4 = aie.buffer(%tile_1_1) {stack_relative_address = 0 : i32, mem_bank = 0 : i32, sym_name = "buf4"} : memref<64x64xbf16>
  %buf3 = aie.buffer(%tile_2_1) {stack_relative_address = 0 : i32, mem_bank = 0 : i32, sym_name = "buf3"} : memref<64x64xf32>
  %buf2 = aie.buffer(%tile_0_2) {stack_relative_address = 1024 : i32, mem_bank = 0 : i32, sym_name = "buf2"} : memref<8x16x4x8xbf16>
  %buf1 = aie.buffer(%tile_0_2) {stack_relative_address = 9216 : i32, mem_bank = 0 : i32, sym_name = "buf1"} : memref<16x8x8x4xbf16>
  %buf0 = aie.buffer(%tile_0_2) {stack_relative_address = 17408 : i32, mem_bank = 0 : i32, sym_name = "buf0"} : memref<16x16x4x4xf32>
