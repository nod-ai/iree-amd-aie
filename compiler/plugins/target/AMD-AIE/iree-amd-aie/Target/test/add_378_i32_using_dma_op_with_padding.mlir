...
module {
  aie.device(npu1_1col) {
    ...
    %objFifo_in0_cons_buff_0 = aie.buffer(%tile_0_1) {stack_relative_address = 0 : i32, sym_name = "objFifo_in0_cons_buff_0"} : memref<16xi32>
    %objFifo_in0_cons_buff_1 = aie.buffer(%tile_0_1) {stack_relative_address = 64 : i32, sym_name = "objFifo_in0_cons_buff_1"} : memref<16xi32>
