...
aie.device(npu1_4col) {
  ...
  %buf5 = aie.buffer(%tile_0_1) {stack_relative_address = 0 : i32, mem_bank = 0 : i32, sym_name = "buf5"} : memref<16x8xi32>
  %buf4 = aie.buffer(%tile_1_1) {stack_relative_address = 0 : i32, mem_bank = 0 : i32, sym_name = "buf4"} : memref<8x16xi32>
  %buf3 = aie.buffer(%tile_2_1) {stack_relative_address = 0 : i32, mem_bank = 0 : i32, sym_name = "buf3"} : memref<16x16xi32>
  %buf2 = aie.buffer(%tile_0_2) {stack_relative_address = 1024 : i32, mem_bank = 0 : i32, sym_name = "buf2"} : memref<1x4x4x8xi32>
  %buf1 = aie.buffer(%tile_0_2) {stack_relative_address = 1536 : i32, mem_bank = 0 : i32, sym_name = "buf1"} : memref<4x1x8x4xi32>
  %buf0 = aie.buffer(%tile_0_2) {stack_relative_address = 2048 : i32, mem_bank = 0 : i32, sym_name = "buf0"} : memref<4x4x4x4xi32>
