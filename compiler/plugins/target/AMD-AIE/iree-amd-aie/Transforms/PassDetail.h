...
#define GEN_PASS_DEF_AMDAIEDISTRIBUTESHAREDMEMORY
#define GEN_PASS_DEF_AMDAIELOCALFORALLTOFOR
#define GEN_PASS_DEF_AMDAIEDISTRIBUTELOCALMEMORY
#define GEN_PASS_DEF_AMDAIEUNROLLLOCALLOOPS
#define GEN_PASS_DEF_AMDAIEINSERTLOGICALOBJECTFIFOACCESS
#define GEN_PASS_DEF_AMDAIEASSIGNTILELOCATIONS
