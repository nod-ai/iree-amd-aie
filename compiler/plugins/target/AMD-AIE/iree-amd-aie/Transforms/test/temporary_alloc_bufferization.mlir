...
//   CHECK-DAG:   %[[BUFFER_0_3:.*]] = amdaie.buffer(%[[TILE_0_3]]) : memref<1024xf32, 2 : i32>
...
//   CHECK-NOT:     memref.alloc
//       CHECK:     %[[CAST:.*]] = memref.reinterpret_cast %[[BUFFER_0_3]]
//       CHECK:     linalg.fill ins(%{{.*}}) outs(%[[CAST]]
//   CHECK-NOT:     dealloc
//   CHECK-NOT:     memref.alloc
//       CHECK:     %[[CAST_1:.*]] = memref.reinterpret_cast %[[BUFFER_0_3]]
