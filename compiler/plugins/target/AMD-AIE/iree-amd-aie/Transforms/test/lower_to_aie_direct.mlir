// RUN: iree-opt --split-input-file --pass-pipeline="builtin.module(iree-amdaie-lower-to-aie,aie.device(aie-assign-lock-ids,aie-objectFifo-stateful-transform,aie-assign-bd-ids,aie-assign-buffer-addresses-basic))" --verify-diagnostics %s | FileCheck %s
