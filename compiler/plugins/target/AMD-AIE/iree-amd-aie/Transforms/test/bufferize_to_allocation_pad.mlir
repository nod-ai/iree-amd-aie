// RUN: iree-opt --pass-pipeline='builtin.module(hal.executable(hal.executable.variant(iree-amdaie-bufferize-to-allocation{memory-space=1 padding-level=1})))' --split-input-file %s | FileCheck %s --check-prefix=PAD-LEVEL-1
// RUN: iree-opt --pass-pipeline='builtin.module(hal.executable(hal.executable.variant(iree-amdaie-bufferize-to-allocation{memory-space=2 padding-level=2})))' --split-input-file %s | FileCheck %s --check-prefix=PAD-LEVEL-2
      ...
      func.func @matmul_static() {
        ...
        %8 = scf.forall (%arg0, %arg1) = (0, 0) to (8, 8) step (8, 8) shared_outs(%arg2 = %5) -> (tensor<8x8xi32>) {
          ...
          scf.forall.in_parallel {
            tensor.parallel_insert_slice %20 into %arg2[%arg0, %arg1] [8, 8] [1, 1] : tensor<8x8xi32> into tensor<8x8xi32>
          }
        ...
        func.func @matmul_static() {
          ...
          %6 = scf.forall (%arg0, %arg1) = (0, 0) to (8, 8) step (8, 8) shared_outs(%arg2 = %5) -> (tensor<8x8xi32>) {
            ...
            %15 = scf.forall (%arg3, %arg4) = (0, 0) to (8, 8) step (4, 4) shared_outs(%arg5 = %14) -> (tensor<8x8xi32>) {
              ...
              %extracted_slice_6 = tensor.extract_slice %17[%arg3, %arg4] [4, 4] [1, 1] : tensor<8x8xi32> to tensor<4x4xi32>
              ...
              scf.forall.in_parallel {
                tensor.parallel_insert_slice %22 into %arg5[%arg3, %arg4] [4, 4] [1, 1] : tensor<4x4xi32> into tensor<8x8xi32>
              }
            } {mapping = [#gpu.block<y>, #gpu.block<x>]}
