...
TEST(SelectTileSizeTest, L2TileSizeTest) {
  ...
  EXPECT_EQ(
      (selectL2TileSizes(
          {524288, 4, 4, 0, 4, 2, 2, 2, 0, 512, 512, 64, 4, 4, 8}, 32, 32)),
      (TileSize{512, 256, 64}));
  EXPECT_EQ(
      (selectL2TileSizes(
          {524288, 2, 2, 0, 4, 2, 2, 2, 0, 512, 512, 64, 4, 4, 8}, 32, 32)),
      (TileSize{512, 512, 64}));
  EXPECT_EQ(
      (selectL2TileSizes(
          {524288, 2, 2, 0, 4, 2, 2, 2, 0, 1024, 1024, 64, 4, 4, 8}, 32, 32)),
      (TileSize{1024, 512, 64}));
  EXPECT_EQ(
      (selectL2TileSizes(
          {524288, 1, 1, 0, 4, 2, 2, 2, 0, 1024, 1024, 64, 4, 4, 8}, 32, 32)),
      (TileSize{1024, 1024, 64}));
  EXPECT_EQ(
      (selectL2TileSizes(
          {524288, 1, 1, 0, 1, 2, 2, 2, 0, 2048, 2048, 128, 4, 4, 8}, 64, 64)),
      (TileSize{1024, 512, 128}));
}
