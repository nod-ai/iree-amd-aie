...
// CHECK-SAME:    @[[OBJ1]]
// CHECK-SAME:    Consume
// CHECK:         %[[ACCESS_0:.+]] = aie.objectfifo.subview.access
// CHECK-SAME:    %[[ACQUIRE_0]]
// CHECK:         %[[REINTERPRET_0:.+]] = memref.reinterpret_cast
// CHECK-SAME:    %[[ACCESS_0]]
...
// CHECK-SAME:    @[[OBJ1]]
// CHECK-SAME:    Consume
// CHECK:         %[[ACCESS_1:.+]] = aie.objectfifo.subview.access
// CHECK-SAME:    %[[ACQUIRE_1]]
// CHECK:         %[[REINTERPRET_1:.+]] = memref.reinterpret_cast
// CHECK-SAME:    %[[ACCESS_1]]
// CHECK:         scf.for %{{.+}} = %[[C0]] to %[[C8]] step %[[C1]]
// CHECK:           linalg.fill
