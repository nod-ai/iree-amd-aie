// RUN: iree-opt --split-input-file --pass-pipeline='builtin.module(func.func(iree-amdaie-fuse-pack-into-for))' %s | FileCheck %s --check-prefix=DEPTH-1
// RUN: iree-opt --split-input-file --pass-pipeline='builtin.module(func.func(iree-amdaie-fuse-pack-into-for{fuse-pack-depth=2}))' %s | FileCheck %s --check-prefix=DEPTH-2
