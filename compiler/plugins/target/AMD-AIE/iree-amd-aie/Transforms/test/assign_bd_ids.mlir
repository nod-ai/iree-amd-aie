...
// CHECK:             amdaie.dma_bd(%[[IN]] : memref<16xi32>) {bd_id = 0 : i32, dimensions = #amdaie<bd_dim_layout_array[<size = 2, stride = 1>, <size = 3, stride = 2>, <size = 2, stride = 4>, <size = 1, stride = 1>]>, len = 16 : i32}
