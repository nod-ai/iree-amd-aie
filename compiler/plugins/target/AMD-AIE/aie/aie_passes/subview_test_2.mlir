...
// CHECK:           %[[OF2_LOCK_0:.*]] = aie.lock(%[[TILE_1_2]], 4) {init = 0 : i32, sym_name = "of2_lock_0"}
// CHECK:           %[[OF2_LOCK_1:.*]] = aie.lock(%[[TILE_1_2]], 5) {init = 0 : i32, sym_name = "of2_lock_1"}
// CHECK:           %[[OF2_LOCK_2:.*]] = aie.lock(%[[TILE_1_2]], 6) {init = 0 : i32, sym_name = "of2_lock_2"}
...
// CHECK:             aie.use_lock(%[[OF2_LOCK_2]], Acquire, 0)
