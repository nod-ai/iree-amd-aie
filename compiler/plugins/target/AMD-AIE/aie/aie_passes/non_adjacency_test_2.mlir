...
// CHECK:           %[[OBJFIFO_CONS_LOCK_2:.*]] = aie.lock(%[[TILE_3_3]], 2) {init = 0 : i32, sym_name = "objfifo_cons_lock_2"}
// CHECK:           %[[OBJFIFO_CONS_LOCK_3:.*]] = aie.lock(%[[TILE_3_3]], 3) {init = 0 : i32, sym_name = "objfifo_cons_lock_3"}
...
// CHECK:               aie.use_lock(%[[OBJFIFO_CONS_LOCK_2]], Release, 0)
// CHECK:               aie.use_lock(%[[OBJFIFO_CONS_LOCK_1]], Acquire, 1)
// CHECK:               func.call @some_work(%[[OBJFIFO_CONS_BUFF_3]]) : (memref<16xi32>) -> ()
// CHECK:               aie.use_lock(%[[OBJFIFO_CONS_LOCK_3]], Release, 0)
// CHECK:             }
// CHECK:             aie.end
// CHECK:           }
...
// CHECK:           ^bb3:
// CHECK:             aie.use_lock(%[[OBJFIFO_CONS_LOCK_2]], Acquire, 0)
// CHECK:             aie.dma_bd(%[[OBJFIFO_CONS_BUFF_2]] : memref<16xi32>, 0, 16)
// CHECK:             aie.use_lock(%[[OBJFIFO_CONS_LOCK_2]], Release, 1)
// CHECK:             aie.next_bd ^bb4
// CHECK:           ^bb4:
// CHECK:             aie.use_lock(%[[OBJFIFO_CONS_LOCK_3]], Acquire, 0)
// CHECK:             aie.dma_bd(%[[OBJFIFO_CONS_BUFF_3]] : memref<16xi32>, 0, 16)
// CHECK:             aie.use_lock(%[[OBJFIFO_CONS_LOCK_3]], Release, 1)
// CHECK:             aie.next_bd ^bb1
// CHECK:           ^bb5:
// CHECK:             aie.end
// CHECK:           }
