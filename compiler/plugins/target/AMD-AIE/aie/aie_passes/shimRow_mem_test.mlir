...
// CHECK:           %[[OBJFIFO_CONS_BUFF_0:.*]] = aie.buffer(%[[TILE_7_1]]) {sym_name = "objfifo_cons_buff_0"} : memref<16xi32>
...
// CHECK:           %[[OBJFIFO_CONS_LOCK_0:.*]] = aie.lock(%[[TILE_7_1]], 0) {init = 0 : i32, sym_name = "objfifo_cons_lock_0"}
// CHECK:           %[[OBJFIFO_CONS_LOCK_1:.*]] = aie.lock(%[[TILE_7_1]], 1) {init = 0 : i32, sym_name = "objfifo_cons_lock_1"}
// CHECK:           %[[OBJFIFO_CONS_LOCK_2:.*]] = aie.lock(%[[TILE_7_1]], 2) {init = 0 : i32, sym_name = "objfifo_cons_lock_2"}
// CHECK:           %[[OBJFIFO_LOCK_0:.*]] = aie.lock(%[[TILE_7_0]], 0) {init = 0 : i32, sym_name = "objfifo_lock_0"}
