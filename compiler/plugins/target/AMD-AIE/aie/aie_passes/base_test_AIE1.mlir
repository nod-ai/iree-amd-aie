...
// CHECK:           %[[OF1_CONS_LOCK_0:.*]] = aie.lock(%[[TILE_3_3]], 0) {init = 0 : i32, sym_name = "of1_cons_lock_0"}
// CHECK:           %[[OF1_CONS_LOCK_1:.*]] = aie.lock(%[[TILE_3_3]], 1) {init = 0 : i32, sym_name = "of1_cons_lock_1"}
...
// CHECK:           %[[OF1_LOCK_0:.*]] = aie.lock(%[[TILE_1_2]], 4) {init = 0 : i32, sym_name = "of1_lock_0"}
// CHECK:           %[[OF1_LOCK_1:.*]] = aie.lock(%[[TILE_1_2]], 5) {init = 0 : i32, sym_name = "of1_lock_1"}
...
// CHECK:           %[[OF0_LOCK_0:.*]] = aie.lock(%[[TILE_1_2]], 0) {init = 0 : i32, sym_name = "of0_lock_0"}
// CHECK:           %[[OF0_LOCK_1:.*]] = aie.lock(%[[TILE_1_2]], 1) {init = 0 : i32, sym_name = "of0_lock_1"}
// CHECK:           %[[OF0_LOCK_2:.*]] = aie.lock(%[[TILE_1_2]], 2) {init = 0 : i32, sym_name = "of0_lock_2"}
// CHECK:           %[[OF0_LOCK_3:.*]] = aie.lock(%[[TILE_1_2]], 3) {init = 0 : i32, sym_name = "of0_lock_3"}
...
// CHECK:           ^bb2:
// CHECK:             aie.use_lock(%[[OF1_LOCK_1]], Acquire, 1)
// CHECK:             aie.dma_bd(%[[OF1_BUFF_1]] : memref<16xi32>, 0, 16)
// CHECK:             aie.use_lock(%[[OF1_LOCK_1]], Release, 0)
