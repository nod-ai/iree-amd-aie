...
// CHECK:             aie.connect<DMA : 1, East : 2>
// CHECK:           }
...
module {
    aie.device(npu1_4col) {
      ...
      aie.flow(%tile_0_3, DMA : 0, %tile_3_0, DMA : 0)
      aie.flow(%tile_0_3, DMA : 1, %tile_3_3, DMA : 1)
      aie.flow(%tile_0_2, DMA : 0, %tile_3_2, DMA : 0)
      aie.flow(%tile_2_2, DMA : 0, %tile_2_0, DMA : 0)
      aie.flow(%tile_2_2, Core : 0, %tile_1_3, Core : 0)
      aie.flow(%tile_0_3, DMA : 1, %tile_0_2, Core : 0)
      aie.flow(%tile_3_4, Core : 0, %tile_3_1, DMA : 0)
      aie.flow(%tile_3_4, DMA : 0, %tile_3_2, DMA : 1)
      aie.flow(%tile_3_4, DMA : 1, %tile_3_3, DMA : 0)
      aie.flow(%tile_3_1, DMA : 0, %tile_2_0, DMA : 1)
      aie.flow(%tile_3_1, DMA : 1, %tile_3_0, DMA : 1)
      aie.flow(%tile_0_3, Core : 0, %tile_0_2, DMA : 1)
      aie.flow(%tile_1_3, DMA : 1, %tile_3_1, DMA : 1)
    }
}
