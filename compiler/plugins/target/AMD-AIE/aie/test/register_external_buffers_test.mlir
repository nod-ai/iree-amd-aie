...
// CHECK:           %[[EXT_OF_CONS_PROD_LOCK:.*]] = aie.lock(%[[TILE_3_2]]) {init = 3 : i8, sym_name = "ext_of_cons_prod_lock"}
// CHECK:           %[[EXT_OF_CONS_CONS_LOCK:.*]] = aie.lock(%[[TILE_3_2]]) {init = 0 : i8, sym_name = "ext_of_cons_cons_lock"}
// CHECK:           %[[EXT_OF_PROD_LOCK:.*]] = aie.lock(%[[TILE_3_0]]) {init = 0 : i8, sym_name = "ext_of_prod_lock"}
// CHECK:           %[[EXT_OF_CONS_LOCK:.*]] = aie.lock(%[[TILE_3_0]]) {init = 0 : i8, sym_name = "ext_of_cons_lock"}
