...
// CHECK:           %[[FROM_MEMTILE_CONS_CONS_LOCK:.*]] = aie.lock(%[[TILE_2_2]], 1) {init = 0 : i8, sym_name = "from_memTile_cons_cons_lock"}
...
// CHECK:           %[[TO_MEMTILE_CONS_PROD_LOCK:.*]] = aie.lock(%[[TILE_2_1]], 0) {init = 2 : i8, sym_name = "to_memTile_cons_prod_lock"}
// CHECK:           %[[TO_MEMTILE_CONS_CONS_LOCK:.*]] = aie.lock(%[[TILE_2_1]], 1) {init = 0 : i8, sym_name = "to_memTile_cons_cons_lock"}
// CHECK:           %[[TO_MEMTILE_PROD_LOCK:.*]] = aie.lock(%[[TILE_2_0]], 0) {init = 0 : i8, sym_name = "to_memTile_prod_lock"}
// CHECK:           %[[TO_MEMTILE_CONS_LOCK:.*]] = aie.lock(%[[TILE_2_0]], 1) {init = 0 : i8, sym_name = "to_memTile_cons_lock"}
