...
// CHECK:           %[[MEM_OUT_CONS_PROD_LOCK:.*]] = aie.lock(%[[TILE_0_3]]) {init = 4 : i8, sym_name = "mem_out_cons_prod_lock"}
// CHECK:           %[[MEM_OUT_CONS_CONS_LOCK:.*]] = aie.lock(%[[TILE_0_3]]) {init = 0 : i8, sym_name = "mem_out_cons_cons_lock"}
...
// CHECK:           %[[MEM_IN_0_CONS_PROD_LOCK:.*]] = aie.lock(%[[TILE_0_2]]) {init = 2 : i8, sym_name = "mem_in_0_cons_prod_lock"}
// CHECK:           %[[MEM_IN_0_CONS_CONS_LOCK:.*]] = aie.lock(%[[TILE_0_2]]) {init = 0 : i8, sym_name = "mem_in_0_cons_cons_lock"}
...
// CHECK:           %[[MEM_IN_1_CONS_PROD_LOCK:.*]] = aie.lock(%[[TILE_0_1]]) {init = 7 : i8, sym_name = "mem_in_1_cons_prod_lock"}
// CHECK:           %[[MEM_IN_1_CONS_CONS_LOCK:.*]] = aie.lock(%[[TILE_0_1]]) {init = 0 : i8, sym_name = "mem_in_1_cons_cons_lock"}
// CHECK:           %[[MEM_IN_PROD_LOCK:.*]] = aie.lock(%[[TILE_0_0]]) {init = 0 : i8, sym_name = "mem_in_prod_lock"}
// CHECK:           %[[MEM_IN_CONS_LOCK:.*]] = aie.lock(%[[TILE_0_0]]) {init = 0 : i8, sym_name = "mem_in_cons_lock"}
