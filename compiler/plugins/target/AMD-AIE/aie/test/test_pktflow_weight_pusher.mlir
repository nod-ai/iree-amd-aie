...
// CHECK:             %[[VAL_4:.*]] = aie.masterset(DMA : 1, %[[VAL_2]])
// CHECK:             %[[VAL_5:.*]] = aie.masterset(WEST : 2, %[[VAL_3]])
// CHECK:             aie.packet_rules(EAST : 2) {
// CHECK:               aie.rule(31, 0, %[[VAL_3]])
// CHECK:               aie.rule(31, 4, %[[VAL_2]])
// CHECK:             }
// CHECK:           }
...
// CHECK:             %[[VAL_13:.*]] = aie.masterset(DMA : 1, %[[VAL_10]])
// CHECK:             %[[VAL_14:.*]] = aie.masterset(WEST : 0, %[[VAL_11]])
// CHECK:             %[[VAL_15:.*]] = aie.masterset(WEST : 3, %[[VAL_12]])
// CHECK:             aie.packet_rules(NORTH : 1) {
// CHECK:               aie.rule(31, 8, %[[VAL_11]])
...
// CHECK:             %[[VAL_26:.*]] = aie.masterset(DMA : 1, %[[VAL_24]])
// CHECK:             %[[VAL_27:.*]] = aie.masterset(SOUTH : 1, %[[VAL_25]])
// CHECK:             aie.packet_rules(NORTH : 2) {
// CHECK:               aie.rule(31, 13, %[[VAL_24]])
// CHECK:               aie.rule(27, 8, %[[VAL_25]])
// CHECK:             }
// CHECK:           }
...
// CHECK:             %[[VAL_30:.*]] = aie.masterset(DMA : 1, %[[VAL_28]])
// CHECK:             %[[VAL_31:.*]] = aie.masterset(SOUTH : 2, %[[VAL_29]])
// CHECK:             aie.packet_rules(EAST : 1) {
// CHECK:               aie.rule(31, 1, %[[VAL_29]])
// CHECK:               aie.rule(31, 2, %[[VAL_28]])
// CHECK:             }
// CHECK:           }
...
// CHECK:             %[[VAL_34:.*]] = aie.masterset(DMA : 1, %[[VAL_32]])
// CHECK:             %[[VAL_35:.*]] = aie.masterset(WEST : 1, %[[VAL_33]])
// CHECK:             aie.packet_rules(NORTH : 1) {
// CHECK:               aie.rule(31, 6, %[[VAL_32]])
// CHECK:               aie.rule(28, 0, %[[VAL_33]])
// CHECK:             }
// CHECK:           }
...
// CHECK:             %[[VAL_39:.*]] = aie.masterset(DMA : 1, %[[VAL_36]])
// CHECK:             %[[VAL_40:.*]] = aie.masterset(SOUTH : 0, %[[VAL_37]])
// CHECK:             %[[VAL_41:.*]] = aie.masterset(SOUTH : 1, %[[VAL_38]])
// CHECK:             aie.packet_rules(NORTH : 0) {
// CHECK:               aie.rule(31, 9, %[[VAL_37]])
...
// CHECK:             %[[VAL_44:.*]] = aie.masterset(DMA : 1, %[[VAL_42]])
// CHECK:             %[[VAL_45:.*]] = aie.masterset(SOUTH : 2, %[[VAL_43]])
// CHECK:             aie.packet_rules(EAST : 1) {
// CHECK:               aie.rule(31, 14, %[[VAL_42]])
// CHECK:               aie.rule(26, 8, %[[VAL_43]])
// CHECK:             }
// CHECK:           }
...
// CHECK:             %[[VAL_51:.*]] = aie.masterset(DMA : 1, %[[VAL_48]])
// CHECK:             %[[VAL_52:.*]] = aie.masterset(SOUTH : 1, %[[VAL_49]])
// CHECK:             %[[VAL_53:.*]] = aie.masterset(WEST : 1, %[[VAL_50]])
// CHECK:             aie.packet_rules(EAST : 2) {
// CHECK:               aie.rule(31, 3, %[[VAL_50]])
// CHECK:               aie.rule(31, 7, %[[VAL_48]])
// CHECK:               aie.rule(24, 0, %[[VAL_49]])
// CHECK:             }
// CHECK:           }
...
// CHECK:             %[[VAL_58:.*]] = aie.masterset(DMA : 1, %[[VAL_56]])
// CHECK:             %[[VAL_59:.*]] = aie.masterset(SOUTH : 0, %[[VAL_57]])
// CHECK:             %[[VAL_60:.*]] = aie.masterset(SOUTH : 3, %[[VAL_54]])
// CHECK:             %[[VAL_61:.*]] = aie.masterset(WEST : 2, %[[VAL_55]])
// CHECK:             aie.packet_rules(EAST : 2) {
// CHECK:               aie.rule(31, 5, %[[VAL_54]])
// CHECK:               aie.rule(24, 0, %[[VAL_55]])
// CHECK:             }
// CHECK:             aie.packet_rules(EAST : 3) {
// CHECK:               aie.rule(31, 11, %[[VAL_56]])
// CHECK:               aie.rule(28, 8, %[[VAL_57]])
// CHECK:             }
// CHECK:           }
...
// CHECK:             %[[VAL_65:.*]] = aie.masterset(DMA : 1, %[[VAL_63]])
// CHECK:             %[[VAL_66:.*]] = aie.masterset(WEST : 2, %[[VAL_62]])
// CHECK:             %[[VAL_67:.*]] = aie.masterset(WEST : 3, %[[VAL_64]])
// CHECK:             aie.packet_rules(EAST : 2) {
// CHECK:               aie.rule(24, 0, %[[VAL_62]])
// CHECK:             }
// CHECK:             aie.packet_rules(EAST : 3) {
// CHECK:               aie.rule(31, 15, %[[VAL_63]])
// CHECK:               aie.rule(28, 8, %[[VAL_64]])
// CHECK:             }
// CHECK:           }
...
// CHECK:             }
// CHECK:             aie.packet_rules(EAST : 0) {
// CHECK:               aie.rule(31, 9, %[[VAL_71]])
// CHECK:               aie.rule(31, 10, %[[VAL_71]])
// CHECK:               aie.rule(27, 11, %[[VAL_71]])
