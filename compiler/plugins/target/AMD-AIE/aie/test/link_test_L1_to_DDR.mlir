...
// CHECK:           %[[FROM_MEMTILE_CONS_PROD_LOCK:.*]] = aie.lock(%[[TILE_2_0]]) {init = 0 : i8, sym_name = "from_memTile_cons_prod_lock"}
// CHECK:           %[[FROM_MEMTILE_CONS_CONS_LOCK:.*]] = aie.lock(%[[TILE_2_0]]) {init = 0 : i8, sym_name = "from_memTile_cons_cons_lock"}
...
// CHECK:           %[[FROM_MEMTILE_PROD_LOCK:.*]] = aie.lock(%[[TILE_2_1]]) {init = 2 : i8, sym_name = "from_memTile_prod_lock"}
// CHECK:           %[[FROM_MEMTILE_CONS_LOCK:.*]] = aie.lock(%[[TILE_2_1]]) {init = 0 : i8, sym_name = "from_memTile_cons_lock"}
...
// CHECK:           %[[TO_MEMTILE_PROD_LOCK:.*]] = aie.lock(%[[TILE_2_2]]) {init = 2 : i8, sym_name = "to_memTile_prod_lock"}
// CHECK:           %[[TO_MEMTILE_CONS_LOCK:.*]] = aie.lock(%[[TILE_2_2]]) {init = 0 : i8, sym_name = "to_memTile_cons_lock"}
